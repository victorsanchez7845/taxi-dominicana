...
/*!*****************************************!*\
  !*** ./resources/js/process/listing.js ***!
  \*****************************************/
(function () {
  ...
  if (automatic_scroll) {
    automatic_scroll.scrollIntoView({
      behavior: 'smooth'
    });
  }
  function initMap() {
  ...
  function calculateAndDisplayRoute(directionsService, directionsDisplay) {
    ...
    directionsService.route({
      origin: "".concat(data.from.lat, ",").concat(data.from.lng),
      destination: "".concat(data.to.lat, ",").concat(data.to.lng),
      travelMode: 'DRIVING'
