<header class="header_full_width_container">
    ...
    <nav class="navbar">
        <a class="navbar-brand" href="/" title="Inicio | Punta Cana Airport Transfers">
            <picture>
                <source srcset="/assets/img/logo.webp" type="image/webp">
                <img src="/assets/img/logo.png" width="222" height="82" loading="lazy" alt="Logo | Punta Cana Airport Transfers" title="Logo | Punta Cana Airport Transfers">
            </picture>
        </a>
        
        <button type="button" id="openMenuButton">
            <img src="/assets/img/svg/bars.svg" alt="Menu | Punta Cana Airport Transfers" title="Menu | Punta Cana Airport Transfers" width="25" height="25" loading="lazy">
        </button>

        <div class="collapse">
            <ul>
                <li><a href="/punta-cana-airport-transportation" title="Punta Cana Airport Transportation">Punta Cana Airport Transportation</a></li>
                <li><a href="/punta-cana-to-tulum-shuttle" title="Punta Cana to Tulum Shuttle">Punta Cana to Tulum Shuttle</a></li>
                <li><a href="/transportation-punta-cana-airport-to-playa-del-carmen" title="Transportation from Punta Cana to Playa del Carmen">Transportation from Punta Cana to Playa del Carmen</a></li>
            </ul>
            <ul class="right">
                <li>
                    ...
                    <div class="last">
                        ...
                        <div class="content">
                            ...
                            <div class="items">
                                ...
                                <a href="tel:{{ App\Traits\GeneralTrait::clearPhone( config('services.phone.MX') ) }}" title="México Phone | Punta Cana Airport Transfers">{{  config('services.phone.MX') }}</a>
                                <a href="tel:{{ App\Traits\GeneralTrait::clearPhone( config('services.phone.US') ) }}" title="USA & Canada Phone | Punta Cana Airport Transfers">{{  config('services.phone.US') }}</a>
                            </div>                                
                            <div class="items">
