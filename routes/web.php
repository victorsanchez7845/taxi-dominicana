...
Route::middleware('locale')->group(function () {
    ...
    Route::get('/punta-cana-airport-transportation', [DestinationsController::class, 'punta-cana'])->name('destination.punta-cana');
    Route::get('/punta-cana-to-tulum-shuttle', [DestinationsController::class, 'tulum'])->name('destination.tulum');
    Route::get('/transportation-punta-cana-airport-to-playa-del-carmen', [DestinationsController::class, 'playaDelCarmen'])->name('destination.pdc');
    Route::get('/punta-cana-to-akumal-shuttle', [DestinationsController::class, 'akumal'])->name('destination.akumal');
...
Route::get('images/new_app/taxi-punta-cana-aeropuerto-banner.webp', [RedirectController::class, 'redirectVanBanner']);
...
Route::get('images/taxi-punta-cana-aeropuerto-van.webp', [RedirectController::class, 'redirectServicesOne']);
Route::get('images/punta-cana-airport-transportation-suburban.webp', [RedirectController::class, 'redirectServicesTwo']);
Route::get('/images/taxi-punta-cana-aeropuerto-crafter.webp', [RedirectController::class, 'redirectServicesThree']);
